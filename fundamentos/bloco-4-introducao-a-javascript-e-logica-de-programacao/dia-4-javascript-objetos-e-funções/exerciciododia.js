...
// 2 - Insira no objeto uma nova propriedade com o nome de  
//chave 'recorrente' e o valor 'Sim' e, em seguida, imprima o objeto no console.
...
//5 defina um segundo objeto com a mesma estrutura (as mesmas chaves) do primeiro e os seguintes 
...
for (let index in newInfo) {
    console.log(index, '=> ', newInfo[index]);
}
